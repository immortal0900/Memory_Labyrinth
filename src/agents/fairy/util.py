...
def stream_action_llm(model="llama-3.3-70b-versatile", system_prompt=None, question=None):
...
def call_action_llm(model="llama-3.3-70b-versatile", max_token = 200, system_prompt=None, question=None):
    if system_prompt is None or question is None:
        raise RuntimeError("시스템 프롬프트 혹은 질문 프롬프트가 필요합니다.")
